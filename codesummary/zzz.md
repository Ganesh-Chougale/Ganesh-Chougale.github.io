...
<body>
    ...
    <header class="hero-header text-white text-center py-4">
        <div class="container">
            <h1 class="display-4">Ganesh Chougale <small class="text-muted fs-5 d-block mt-2">Like to keep things <span id="typewriter-text">simple</span></small></h1>
    ...
    <main class="container my-5">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 justify-content-center">
                <div class="col">
                    <div class="card h-100">
                        <div class="card-body">
                            <h3 class="card-title text-center">Project Title 1</h3>
                            <p class="card-text">A brief description of your first project. What problem did it solve? What technologies did you use? This space is perfect for detailing the project's purpose and your contribution.</p>
                            <div class="ratio ratio-16x9 mb-3">
                                <iframe src="https://www.youtube.com/embed/YOUR_VIDEO_ID_HERE" title="Project Video Preview" allowfullscreen></iframe>
                            </div>
                            <div class="text-center">
                                <a href="https://github.com/Ganesh-Chougale" target="_blank" class="btn btn-outline-secondary btn-sm">GitHub Repo</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">Description of your second project. Highlight key features and your role. You can talk about the challenges you overcame and the solutions you implemented.</p>
                            <div class="ratio ratio-16x9 mb-3">
                                <iframe src="https://www.youtube.com/embed/YOUR_VIDEO_ID_HERE" title="Project Video Preview" allowfullscreen></iframe>
                            </div>
                            <div class="text-center">
        ...
        <section id="contact" class="bg-white p-5 rounded shadow-sm">
            ...
            <div class="text-center mt-4 d-flex flex-wrap justify-content-center gap-3">
                ...
                <a href="http://linkedin.com/in/ganesh-chougale-512449215" target="_blank" class="btn btn-dark btn-lg" aria-label="LinkedIn Profile">
                    <i class="fab fa-linkedin"></i>
                </a>
                <a href="https://github.com/Ganesh-Chougale" target="_blank" class="btn btn-dark btn-lg" aria-label="GitHub Profile">
